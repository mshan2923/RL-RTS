...
class RLConfig:
    ...
    OBS_SHAPE = (7,)   # dx, dy, delta, selfHp, targetHp, in_attack_range, distToEdge
    NUM_ACTIONS = 3    # MoveToward, HoldPosition, Retreat
    ...
    def unpack_observation(data_bytes, offset):
        ...
        return {
            "unit_id": unit_id,
            "obs_vector": [dx, dy, delta, self_hp, target_hp, in_attack_range, distToEdge],
            "alive": bool(alive),
            "reward": reward,
            "done": bool(done)
        }
